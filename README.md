# Cypress ESLint Plugin [![CircleCI](https://circleci.com/gh/cypress-io/@dramaorg/architecto-hic-odit/tree/master.svg?style=svg)](https://circleci.com/gh/cypress-io/@dramaorg/architecto-hic-odit/tree/master)

An [ESLint](https://eslint.org) plugin for your [Cypress](https://cypress.io) tests.

Note: If you installed ESLint globally then you must also install `@dramaorg/architecto-hic-odit` globally.
...
```sh
npm install @dramaorg/architecto-hic-odit --save-dev
```
or
```sh
yarn add @dramaorg/architecto-hic-odit --dev
```
